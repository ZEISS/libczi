...
TEST(BitmapOperations, CopyWithOffsetGray8ToGray8_1)
{
    ...
    ASSERT_TRUE(0 == memcmp(destination_locked.ptrDataRoi, expected_result_data, 8 * 8));
}
...
TEST(BitmapOperations, CopyWithOffsetGray16ToGray16_1)
{
    ...
    ASSERT_TRUE(0 == memcmp(destination_locked.ptrDataRoi, expected_result_data, 8 * 8 * 2));
}
