...
============
 ...
 0.54.1             | [74](https://github.com/ZEISS/libczi/pull/74)        | minor bug fix
 0.54.2             | [78](https://github.com/ZEISS/libczi/pull/78)        | optimization: for multi-tile-composition, check relevant tiles for visibility before loading them (and do not load/decode non-visible tiles)